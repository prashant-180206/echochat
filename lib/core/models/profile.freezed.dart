...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,name,createdAt,bio,gender,avatarUrl);

@override
String toString() {
  return 'Profile(id: $id, email: $email, name: $name, createdAt: $createdAt, bio: $bio, gender: $gender, avatarUrl: $avatarUrl)';
}
